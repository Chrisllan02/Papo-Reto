...
import { ChevronRight, X, Sparkles, ScrollText, BrainCircuit, Check, ShieldCheck, ChevronLeft } from 'lucide-react';
...
const STEPS: TourStep[] = [
  {
    ...
    title: 'Política Sem Filtro',
    desc: 'Bem-vindo ao PapoReto. Sua ferramenta de transparência radical para acompanhar o Congresso Nacional.',
    icon: ShieldCheck,
    color: 'text-blue-600'
  },
  {
  ...
  },
  {
    id: 'match',
    targetId: 'match',
    title: 'Seu Match Político',
    desc: 'Descubra quais políticos votam como você com nosso Quiz baseado em votações reais.',
    color: 'text-blue-500'
  },
  {
    id: 'explore',
