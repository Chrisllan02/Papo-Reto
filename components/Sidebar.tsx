    ...
    <nav className="h-full flex flex-col" aria-label="Menu Principal">
      <div className="flex-1 space-y-6">
        ...
        <div className="flex flex-col gap-3 items-center xl:items-start w-full">
          ...
          <NavItem id="parties" icon={BarChart3} label="Gráficos" colorClass="bg-gradient-to-r from-spring to-yellow-600" />
      ...
      <div className="mt-auto pt-4 relative">
         ...
         {showAccessMenu && (
             <div className="absolute bottom-full left-0 right-0 mb-3 bg-white/95 dark:bg-midnight/95 backdrop-blur-xl border border-white/40 dark:border-white/20 rounded-[1.5rem] shadow-2xl dark:shadow-[0_0_50px_rgba(0,0,0,0.9)] p-4 flex flex-col gap-3 animate-in slide-in-from-bottom-2 fade-in z-50">
                 ...
                 <button onClick={cycleFontSize} className="flex items-center justify-between p-3 rounded-xl hover:bg-gray-100 dark:hover:bg-white/5 transition-colors w-full text-left">
                 ...
                 <button onClick={toggleHighContrast} className="flex items-center justify-between p-3 rounded-xl hover:bg-gray-100 dark:hover:bg-white/5 transition-colors w-full text-left">
                     <div className="flex items-center gap-3">
                 ...
                 <button onClick={() => { setShowOnboarding(true); setShowAccessMenu(false); }} className="flex items-center justify-between p-3 rounded-xl bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors w-full text-left mt-1">
                     <div className="flex items-center gap-3">
