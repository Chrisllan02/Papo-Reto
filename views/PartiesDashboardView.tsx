        ...
        <div className="max-w-[1800px] mx-auto px-4 md:px-8 py-6 space-y-6 relative z-10 px-safe">
            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white/90 dark:bg-midnight/90 backdrop-blur-3xl rounded-[2.5rem] p-6 md:p-8 border border-white/20 dark:border-white/10 shadow-[0_15px_30px_rgba(0,0,0,0.8)] dark:shadow-[0_10px_30px_rgba(0,0,0,0.8)] flex flex-col justify-center min-h-[550px]">
                        <div className="flex items-center gap-3 mb-6">
