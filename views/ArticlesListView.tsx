...
const ArticlesListView: React.FC<ArticlesListViewProps> = ({ onSelectArticle }) => {
  
  // Helper para renderizar o ícone correto (mesma lógica do EducationView)
    ...
    <div className="w-full h-full bg-[#F5F7FA] dark:bg-black font-sans overflow-y-auto pb-32 animate-in fade-in duration-500">
        ...
        <div className="pt-8 px-6 md:px-12 mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-lg font-medium max-w-2xl leading-relaxed">
                Descomplique a política. Artigos rápidos para entender como Brasília funciona e como isso afeta o seu bolso.
            </p>
        </div>
